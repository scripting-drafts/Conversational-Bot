...
Run the scraper with reddit_to_csv.py, make pairs (pairs.txt) out of the csv file with extract-pairs.py and train your model with DL_Chatbot. For the sake of coherence in the conversations I recommend you run the srapper on a single subreddit.
